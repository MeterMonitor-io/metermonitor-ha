  ...
  <n-card>
    <template #cover>
      <div class="image-container">
        <img v-if="lastPicture && lastPicture.picture.data_bbox && !noBoundingBox" :src="'data:image/'+lastPicture.picture.format+';base64,' + lastPicture.picture.data_bbox" alt="Watermeter" />
